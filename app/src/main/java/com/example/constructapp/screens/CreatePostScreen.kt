...
fun CreatePostScreen(
    ...
    Scaffold(
        ...
        topBar = {
            CreatePostTopBar(onClick = viewModel::onBackButtonClicked, viewModel = viewModel)
        }
    ) { innerPadding ->
        Column(
            modifier = Modifier
...
@Composable
fun CreatePostTopBar(onClick: () -> Unit, viewModel: CreatePostViewModel, modifier: Modifier = Modifier) {
    Row(
